...
def convert(input_nifti_path: str, input_dicom_path: str, output_dicom_path: str, ROI_name: str, ROI_color: str):
    ...
    for ROI in range(1,numberOfROIs+1):
        ...
        elif ROI_color == "tomato":
            roi_contour.ROIDisplayColor = [255, 99, 71]
        elif ROI_color == "orange":
            roi_contour.ROIDisplayColor = [255, 165, 0]
        elif ROI_color == "yellow-green":
            roi_contour.ROIDisplayColor = [154, 205, 50]
        elif ROI_color == "lime":
            roi_contour.ROIDisplayColor = [0, 255, 0]
        elif ROI_color == "cyan":
            roi_contour.ROIDisplayColor = [0, 255, 255]
        elif ROI_color == "turquoise":
            roi_contour.ROIDisplayColor = [64, 224, 208]
        elif ROI_color == "deep-blue-sky":
            roi_contour.ROIDisplayColor = [0, 191, 255]
        elif ROI_color == "blue":
            roi_contour.ROIDisplayColor = [0, 0, 255]
        elif ROI_color == "dark-violet":
            roi_contour.ROIDisplayColor = [148, 0, 211]
        elif ROI_color == "magenta":
            roi_contour.ROIDisplayColor = [255, 0, 255]
        elif ROI_color == "brown":
            roi_contour.ROIDisplayColor = [165, 42, 42]
        elif ROI_color == "tan":
            roi_contour.ROIDisplayColor = [210, 160, 120]
        elif ROI_color == "pink":
            roi_contour.ROIDisplayColor = [255, 192, 203]
